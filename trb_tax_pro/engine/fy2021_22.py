...
@MultiYearDispatcher.register("fy2021_22")
class FY2021_22Engine(TaxEngine):
    """
    Concrete Tax Engine for Financial Year 2021-22.
    Same as FY 2020-21.
    """
    ...
    def _calculate_base_tax_new_regime(self, taxable_income: float) -> float:
        """Calculates base tax using FY 2021-22 New Regime Slabs."""
        tax = 0.0
